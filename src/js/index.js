...
// // Passos:
// // 1. No JavaScript, pegar o evento de submit do formulário para evitar o 
...
// // 5. Receber a resposta da API do n8n (esperando um JSON com o código HTML/CSS 
// do background).
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    form.addEventListener('submit', async function (event) {
        ...
        try {
            const response = await fetch("https://marinadias.app.n8n.cloud/webhook/gerador-fundo", {
                method: "POST",
            ...
            console.error("Erro ao tentar gerar o fundo", error);
